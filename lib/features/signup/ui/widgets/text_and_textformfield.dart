      ...
      child: Column(
        children: [
          ...
          Align(
            ...
            child: Padding(
              padding: EdgeInsets.only(left: 30.0.h, top: 70.h),
              child: Text(
                "Sign Up",
          ...
          Padding(
            padding: EdgeInsets.only(top: 12.0.h,left: 30.w,right: 20.w),
            child: SizedBox(
              width: 350.w,
          ...
          Padding(
            padding: EdgeInsets.only(top: 7.0.h,left: 30.w,right: 20.w),
            child: SizedBox(
              width: 350.w,
              child: AppTextFormField(
          ...
          Padding(
            padding: EdgeInsets.only(top: 7.0.h,left: 30.w,right: 15.w),
            child: SizedBox(
              width: 350.w,
              child: AppTextFormField(
