...
class _ApiServices implements ApiServices {
  ...
  Future<PropertiesModel> getAllPosts(
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<PropertiesModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<MyAdsResponse> getMyAds(String token) async {
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<MyAdsResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = MyAdsResponse.fromJson(_result.data!);
    return value;
  }
  ...
  @override
  Future<HomeAdminResponse> getAdminHome(String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<HomeAdminResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = HomeAdminResponse.fromJson(_result.data!);
    return value;
  }
  ...
  @override
  Future<ApproveContractResponse> acceptProperty(
    String token,
    String propertyId,
  ) async {
    final _extra = <String, dynamic>{};
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ApproveContractResponse>(Options(
      method: 'PATCH',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = ApproveContractResponse.fromJson(_result.data!);
    return value;
  }
  ...
  @override
  Future<RejectContractResponse> rejectProperty(
    String token,
    String propertyId,
  ) async {
    final _extra = <String, dynamic>{};
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<RejectContractResponse>(Options(
      method: 'PATCH',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = RejectContractResponse.fromJson(_result.data!);
    return value;
  }
